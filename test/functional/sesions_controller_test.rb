...
class SesionsControllerTest < ActionController::TestCase
  ...
  test "should create sesion" do
    assert_difference('Sesion.count') do
      post :create, sesion: { fecha_de_sesion: @sesion.fecha_de_sesion, motivo_de_consulta: @sesion.motivo_de_consulta, observaciones: @sesion.observaciones, paciente_id: @sesion.paciente_id }
    end
  ...
  test "should update sesion" do
    put :update, id: @sesion, sesion: { fecha_de_sesion: @sesion.fecha_de_sesion, motivo_de_consulta: @sesion.motivo_de_consulta, observaciones: @sesion.observaciones, paciente_id: @sesion.paciente_id }
    assert_redirected_to sesion_path(assigns(:sesion))
  end
